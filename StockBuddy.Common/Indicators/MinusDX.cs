...
{
    public class MinusDX : IndicatorBase
    {
        public MinusDX() : base() { }

        public MinusDX(int period) : base(period) { }

        public MinusDX(int period, int daysBack) : base(period, daysBack) { }
